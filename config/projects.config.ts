...
export const projectsData: Project[] = [
  ...
  // 1. RinAI - Agentic AI Companion
  {
    ...
    github: `https://github.com/${process.env.NEXT_PUBLIC_GITHUB_HANDLE || 'kmokdefi'}/peak-ai-agent-stack`,
    screenshots: [
  ...
  // 2. LLM Security Auditor
  {
    ...
    github: `https://github.com/${process.env.NEXT_PUBLIC_GITHUB_HANDLE || 'kmokdefi'}/llm-security-auditor`,
    status: "production" as const,
    category: "systems",
    role: "built",
    visibility: "open-source"
  ...
  // 3. Agent State Machine
  {
    ...
    github: `https://github.com/${process.env.NEXT_PUBLIC_GITHUB_HANDLE || 'kmokdefi'}/agent-state-machine`,
    status: "production" as const,
    category: "systems",
    role: "built",
    visibility: "open-source"
  ...
  // 4. RinAI VTuber & Desktop Agent
  {
    ...
    github: `https://github.com/${process.env.NEXT_PUBLIC_GITHUB_HANDLE || 'kmokdefi'}/rinai-multimodal-vtuber`,
    screenshots: [
  ...
  // 5. AI VTuber Trading Battle
  {
    ...
    github: `https://github.com/${process.env.NEXT_PUBLIC_GITHUB_HANDLE || 'kmokdefi'}/ai-vtuber-trading-battle`,
